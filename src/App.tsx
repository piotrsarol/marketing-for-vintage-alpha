...
type SettingsData = { product: { name: string; url: string; description: string; country: string; language: string; audience: string[]; callToAction: string; searchQuery?: string }; ai: { provider: string; model: string; lastRequest: 'openai' | 'mock' | 'unknown' }; publishing: { provider: string; configured: boolean }; storage: string; automation: { dailyWorkflow: boolean; workflowFile: string }; updatedAt?: string }
const trends: Trend[] = []
